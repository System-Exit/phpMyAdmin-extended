 ...
 * @package PhpMyAdmin\Tests\Selenium
 */
class StatsPageTest extends TestBase
{

    /**
     * @var string A test user.
     */
    private $testUser;
    ...
    /**
     * Helper function to go directly to stats page
     *
     * @return void
     */
    private function goToStatsPage()
    {
        // Go to messages page
        $this->expandMore();
        $this->waitForElement('byXPath', "//a[contains(@href, 'userstats.php')]")->click();
